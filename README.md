...
-   **自动更新管理**：一键下载、安装和更新TMDB-Import工具，支持版本检测和自动备份。
...
为了简化 TMDB-Import 工具的使用和维护，我们新增了完整的自动更新管理功能：

#### ✨ 主要特性
- **🔄 自动版本检测**: 实时检查 GitHub 最新版本，智能对比本地版本
- **📦 一键安装更新**: 自动下载、解压、安装，无需手动操作
- **📊 详细状态显示**: 安装状态、版本信息、更新进度一目了然
- **🛡️ 安全备份机制**: 更新前自动备份现有安装，确保数据安全
- **🛠️ 灵活配置选项**: 支持自动路径配置和手动路径设置

#### 🚀 使用方法
1. 打开设置页面 → 工具设置
2. 在"TMDB-Import 自动更新"区域查看状态
3. 点击"更新到最新版本"即可完成更新
4. 系统会自动配置工具路径，无需手动设置

#### 📋 技术实现
- **后端 API**: `/api/tmdb-import-updater` 处理版本检查和更新操作
- **前端组件**: 集成到设置对话框的专用更新管理界面
- **版本追踪**: 使用 Git 提交信息作为版本标识
- **跨平台支持**: Windows、macOS、Linux 全平台兼容

详细使用说明请参考：[TMDB-Import 自动更新功能文档](docs/TMDB_IMPORT_AUTO_UPDATE.md)
