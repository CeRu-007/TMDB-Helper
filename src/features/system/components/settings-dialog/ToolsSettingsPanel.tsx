...
interface ToolsSettingsPanelProps {
  ...
  setTmdbConfig: (config: TMDBConfig | ((prev: TMDBConfig) => TMDBConfig)) => void;
...
export default function ToolsSettingsPanel({
  ...
  const handlePathSelect = useCallback(async () => {
    if (window.electronAPI?.selectDirectory) {
      ...
      const path = prompt(t('tools.enterToolPath'), tmdbImportPath); // eslint-disable-line no-alert
      if (path) {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-6">{t('tools.description')}</p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">{t('tools.manualPathDesc')}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setTmdbConfig((prev) => ({ ...prev, encoding: value }))
                      }
                    >
                  ...
                  <div className="md:col-span-2 flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setTmdbConfig((prev) => ({ ...prev, save_user_profile: checked }))
                      }
                    />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setTmdbConfig((prev) => ({ ...prev, tmdb_username: e.target.value }))
                        }
                    ...
                    <div>
                      ...
                      <div className="relative mt-1">
                        <Input
                          ...
                          onChange={(e) =>
                            setTmdbConfig((prev) => ({ ...prev, tmdb_password: e.target.value }))
                          }
                        ...
                        <Button
                          ...
                          title={
                            showTmdbPassword ? t('tools.hidePassword') : t('tools.showPassword')
                          }
                        >
                          {showTmdbPassword ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setTmdbConfig((prev) => ({ ...prev, backdrop_forced_upload: checked }))
                      }
                    />
                    <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setTmdbConfig((prev) => ({ ...prev, backdrop_vote_after_upload: checked }))
                      }
                    />
                    <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setTmdbConfig((prev) => ({ ...prev, rename_csv_on_import: checked }))
                      }
                    />
                    <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setTmdbConfig((prev) => ({ ...prev, delete_csv_after_import: checked }))
                      }
                    />
                    <div className="flex-1">
                  ...
                  <div className="pt-4">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setTmdbConfig((prev) => ({ ...prev, filter_words: e.target.value }))
                      }
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-foreground">
                      {t('tools.toolPathNotConfigured')}
                    </h4>
                    <p className="text-sm text-muted-foreground mt-2">{t('tools.configIniHint')}</p>
                  </div>
                  <Button variant="outline" onClick={() => setToolsTab('management')}>
      ...
      {toolsTab === 'dependencies' && <DependencyInstaller />}
    </div>
  );
}
