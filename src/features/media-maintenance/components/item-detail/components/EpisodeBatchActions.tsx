...
import { Settings, RotateCcw, Trash2, PlusCircle, Plus, Pencil } from 'lucide-react';
          ...
          <CardTitle className="text-base flex items-center">
            ...
            {currentSeason && selectedSeason !== undefined && (
              <Badge variant="outline" className="ml-2">
                {t('episodeBatchActions.progress')}: {currentSeason.currentEpisode || 0}/
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const newCount = parseInt(
                        episodeInputRef.current?.value || String(currentSeason.totalEpisodes),
                        10
                      );
          ...
          <div className="w-full mt-3 border-t pt-3 border-border/30">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center space-x-2">
                <div className="text-xs text-muted-foreground">
                  {t('episodeBatchActions.seasonNumber')}:
                </div>
                <Input
                  type="number"
                  min="1"
              ...
              <div className="flex items-center space-x-2">
                <div className="text-xs text-muted-foreground">
                  {t('episodeBatchActions.episodeCount')}:
                </div>
                <Input
                  type="number"
                  min="1"
              ...
              <Button
                ...
                onClick={() => {
                  const episodeCount =
                    parseInt(newSeasonEpisodeInputRef.current?.value || '20', 10) || 20;
