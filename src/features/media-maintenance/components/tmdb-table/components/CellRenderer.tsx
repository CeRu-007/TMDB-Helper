...
import { isValidUrl, isBackdropColumn, isOverviewColumn, isAirDateColumn } from '../lib';
...
export const CellRenderer: React.FC<CellRendererProps> = ({
  ...
  const getCellContent = () => {
    ...
    if (isOverview) {
      return (
        <div
          className={cn(baseClass, hoverClass, 'whitespace-nowrap overflow-hidden text-ellipsis')}
          title={value || ''}
          style={{
            maxWidth: '100%',
            overflow: 'hidden',
