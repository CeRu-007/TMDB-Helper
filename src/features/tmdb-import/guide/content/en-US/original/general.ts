export const content = `# Contribution Guidelines
...
1. We do not recycle entries—AKA use them for something else. Duplicate entries and incorrect entries are deleted.
2. Entries with incorrect data (e.g. a misspelled original title or an incorrect cast) should be fixed, not discarded.
...
> **Note:** Please post directly in the Support Forums if you stumble upon any ongoing sabotage, trolling or malicious edits.
...
Be patient! We receive a high volume of reports. Getting a reply may take a few weeks or months. You can bump your request after six months.
...
Even though we prefer naked posters as primary, good posters with credits and/or text should not be deleted!
...
The genre translations are handled by Travis. Email support@themoviedb.org or reply to this thread on the support forum should you find an incorrect genre translation.
...
We use Google Translate for the language detection. You can use https://translate.google.com to play around with the text until you find a solution that works.
...
A "Size is too large" error is displayed when the image exceeds the maximum dimensions.

# Search Tips

- Use the original title for searching, it's usually the most effective.
- Try different keyword combinations.
- Use the year to narrow down search results.
- Check different language versions of the title.
- Search by actor or director name to find related works.
- Using an IMDb ID can quickly locate specific content.

# Source Reliability

When adding or editing data, it's important to use reliable sources. Official sources such as the movie's official website, press releases, and the websites of production companies and distributors are preferred. User-contributed databases should be used with caution and their data should be verified.

# Moderation

Content moderators are volunteers who help maintain the quality of TMDB's data. They can lock fields, delete entries, merge duplicates, and handle content issue reports. If you need help from a moderator, use the Report button on the relevant entry.

# International Editing

When editing international content, please be mindful of the following:

- Use the original language and script for titles and names.
- Follow the capitalization rules of the specific language.
- Add translations only when there is an official release in that language.
- Do not add unofficial translations.
