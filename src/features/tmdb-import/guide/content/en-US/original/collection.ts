...
> **Note:** Collections are only the beginning. We will implement a proper "universe" feature in the future.
...
The "Parts" section of a collection is where you add the movie sequels that belong to the collection.

When adding parts, please ensure:
