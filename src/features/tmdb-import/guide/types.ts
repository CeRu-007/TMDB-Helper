...
export type GuideCategory =
  'general' | 'new-content' | 'movie' | 'tv' | 'people' | 'collection' | 'image';
...
export const GUIDE_CATEGORIES: Record<GuideCategory, GuideCategoryMeta> = {
  ...
  collection: {
    ...
    subSections: ['general', 'exclusivity', 'type-of-content', 'parts'],
  },
  image: {
    id: 'image',
    icon: 'Image',
    color: 'from-[#032541] to-[#01b4e4]',
    subSections: ['image-quality', 'posters', 'backdrops', 'profiles', 'logos'],
  },
};
