...
const UI_LABELS: Record<string, Record<string, string>> = {
  ...
  generalDesc: {
    'zh-CN': '基本编辑原则和通用规则',
    'en-US': 'Basic editing principles and general rules',
    'ja-JP': '基本的な編集原則と一般ルール',
    'ko-KR': '기본 편집 원칙과 일반 규칙',
    'zh-TW': '基本編輯原則和通用規則',
    'zh-HK': '基本編輯原則和通用規則',
  },
  newContentDesc: {
    'zh-CN': '添加新电影和电视节目',
    'en-US': 'Adding new movies and TV shows',
    'ja-JP': '新しい映画とテレビ番組の追加',
    'ko-KR': '새 영화 및 TV 프로그램 추가',
    'zh-TW': '添加新電影和電視節目',
    'zh-HK': '添加新電影和電視節目',
  },
  imageDesc: {
    'zh-CN': '图片上传和质量标准',
    'en-US': 'Image upload and quality standards',
    'ja-JP': '画像アップロードと品質基準',
    'ko-KR': '이미지 업로드 및 품질 기준',
    'zh-TW': '圖片上傳和品質標準',
    'zh-HK': '圖片上傳和品質標準',
  },
  versionInfo: {
  ...
  summaryDesc: {
    'zh-CN': '精简核心要点，快速掌握编辑规则',
    'en-US': 'Condensed key points for quick reference',
    'ja-JP': '要点を絞った要約で素早く理解',
    'ko-KR': '핵심 요점으로 빠르게 편집 규칙 파악',
    'zh-TW': '精簡核心要點，快速掌握編輯規則',
    'zh-HK': '精簡核心要點，快速掌握編輯規則',
  },
  originalVersion: {
    'zh-CN': '原文版',
    'en-US': 'Original Version',
    'ja-JP': '原文版',
    'ko-KR': '원문 버전',
    'zh-TW': '原文版',
    'zh-HK': '原文版',
  ...
  originalDesc: {
    'zh-CN': '完整原文，包含所有详细说明和示例',
    'en-US': 'Full original text with all details and examples',
    'ja-JP': '完全な原文、すべての詳細説明と例を含む',
    'ko-KR': '전체 원문, 모든 상세 설명과 예시 포함',
    'zh-TW': '完整原文，包含所有詳細說明和示例',
    'zh-HK': '完整原文，包含所有詳細說明和示例',
  },
  needMoreHelp: {
    'zh-CN': '需要更多帮助？',
    'en-US': 'Need more help?',
    'ja-JP': 'もっとヘルプが必要？',
    'ko-KR': '더 많은 도움이 필요하신가요?',
    'zh-TW': '需要更多幫助？',
    'zh-HK': '需要更多幫助？',
  },
  visitTmdbDesc: {
    'zh-CN': '访问TMDB官方网站获取最新的编辑指南和社区支持',
    'en-US': 'Visit TMDB official site for the latest guidelines and community support',
    'ja-JP': 'TMDB公式サイトで最新のガイドラインとコミュニティサポートを入手',
    'ko-KR': 'TMDB 공식 사이트에서 최신 가이드라인과 커뮤니티 지원 확인',
    'zh-TW': '訪問TMDB官方網站獲取最新的編輯指南和社群支持',
    'zh-HK': '訪問TMDB官方網站獲取最新的編輯指南和社群支持',
  },
  helpDescription: {
    'zh-CN':
      '最初只是为了将TMDB的指南翻译为中文，并提供提炼版内容快速了解，现在荒废了，目前是预留，后续可能会考虑移除该功能。',
    'en-US':
      'Originally created to translate TMDB guidelines into Chinese with a condensed summary for quick reference. Now deprecated and kept as a placeholder — may be removed in the future.',
    'ja-JP':
      '当初はTMDBガイドラインを中国語に翻訳し、要約版で素早く理解できるようにするために作成されました。現在は廃止され、プレースホルダーとして残されています。将来的に削除される可能性があります。',
    'ko-KR':
      '원래 TMDB 가이드라인을 중국어로 번역하고 요약 버전으로 빠르게 이해할 수 있도록 만들었습니다. 현재는 더 이상 사용되지 않으며 플레이스홀더로 유지되고 있습니다. 향후 제거될 수 있습니다.',
    'zh-TW':
      '最初只是為了將TMDB的指南翻譯為中文，並提供提煉版內容快速了解，現在荒廢了，目前是預留，後續可能會考慮移除該功能。',
    'zh-HK':
      '最初只是為了將TMDB的指南翻譯為中文，並提供提煉版內容快速了解，現在荒廢了，目前是預留，後續可能會考慮移除該功能。',
  },
};
...
export function TMDBGuide({ activeSection }: { activeSection?: string } = {}) {
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-3 md:space-x-4 mb-3 md:mb-4">
              ...
              <h1 className="text-xl md:text-3xl font-bold truncate">
                {getCategoryLabel(selectedSection, language)} {t('guide', language)}
              </h1>
            </div>
                ...
                <div className="p-4 border-b">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1 text-xs text-gray-500">
                      ...
                      <span>
                        {version === 'summary'
                          ? getVersionLabel(version, language)
                          : getVersionLabel(version, language)}
                      </span>
                    </div>
                  </div>
      ...
      <div className="bg-[#032541] text-white">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-lg">{t('editBible', language)}</span>
            <HelpInfoButton content={t('helpDescription', language)} side="bottom" />
          </div>
          <Button
            variant="ghost"
            className="text-white hover:bg-white/10"
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 flex-1">
            ...
            return (
              ...
              >
                ...
                <CardContent className="relative p-4 md:p-6 text-white h-36 md:h-48 flex flex-col justify-end">
                  ...
                  <h4 className="text-base md:text-lg">{t('guide', language)}</h4>
                </CardContent>
              </Card>
            );
          })}
            ...
            <Card className="border-[#01b4e4]/20 bg-[#01b4e4]/5">
              <CardContent className="p-4 flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-600">{t('summaryDesc', language)}</p>
                </div>
              </CardContent>
            </Card>
            <Card className="border-[#032541]/20 bg-[#032541]/5">
              <CardContent className="p-4 flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-600">{t('originalDesc', language)}</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <Card className="bg-[#032541] text-white">
          <CardContent className="p-5 md:p-6 text-center">
            ...
            <p className="text-gray-300 text-xs md:text-sm mb-4">{t('visitTmdbDesc', language)}</p>
