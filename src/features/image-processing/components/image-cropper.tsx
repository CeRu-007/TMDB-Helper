...
export function ImageCropper() {
  ...
  const handleUpload = useCallback(
    ...
    [images, toast, t, currentRatio.value]
  );
              ...
              <div>
                ...
                <div className="flex items-center gap-1 min-w-0">
                  <input
                    ...
                    value={outW}
                    onChange={(e) =>
                      handleOutWChange(Math.max(1, parseInt(e.target.value, 10) || 1))
                    }
                  ...
                  <input
                    ...
                    value={outH}
                    onChange={(e) =>
                      handleOutHChange(Math.max(1, parseInt(e.target.value, 10) || 1))
                    }
                    className="w-0 flex-1 h-8 px-1.5 text-sm bg-card border border-border rounded-md text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  />
                  <button
              ...
              <div className="space-y-3">
                ...
                {images.length > 1 && (
                  ...
                  >
                    ...
                    {isBatchProcessing
                      ? t('processing')
                      : t('downloadAllCount', { count: images.length })}
                  </Button>
                )}
              </div>
            </div>
