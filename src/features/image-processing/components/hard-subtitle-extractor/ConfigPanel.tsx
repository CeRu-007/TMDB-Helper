    ...
    <div className="h-full flex flex-col overflow-y-auto p-3 md:p-4 space-y-4 md:space-y-6">
      ...
      <div className="space-y-3">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground">{t('hardSubtitle.clickToUploadVideo')}</p>
          <p className="text-xs text-muted-foreground mt-1">{t('hardSubtitle.supportedFormats')}</p>
          <input
            ref={fileInputRef}
            type="file"
            accept="video/*"
      ...
      <div className="space-y-2">
        ...
        {subtitleRegions.length === 0 ? (
          <p className="text-xs text-gray-400">{t('hardSubtitle.clickAndDragToSelect')}</p>
        ) : (
      ...
      <div className="space-y-2">
        ...
        {loadingModels ? (
          ...
          <p className="text-xs text-gray-400">{t('hardSubtitle.notConfiguredOcrModel')}</p>
        ) : (
          <Select
