...
export function ImageRecognition() {
  ...
  const [showAllSimilarImages, setShowAllSimilarImages] = useState(false);
    ...
    try {
      if (advancedSearchMode) {
        ...
        toast({
          ...
          description: t('imageRecognition.foundSimilarImages', {
            count: similarSearchData.results?.length || 0,
          }),
        });
      ...
      toast({
        ...
        description: t('imageRecognition.foundResults', {
          count: (searchData.data.movies || []).length,
        }),
      });
    } catch (error) {
  ...
  const sortedMovies = (analysisResult?.movies || [])
    .sort((a, b) => {
      if (sortBy === 'match') {
    ...
    .filter((movie) =>
      selectedDatabase === 'tmdb' ? movie.source === 'tmdb' : movie.source === 'imdb'
    );
          ...
          <Card className="flex-shrink-0">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <HelpInfoButton content={t('imageRecognition.helpDescription')} side="right" />
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-card rounded-lg">
                ...
                <Switch checked={advancedSearchMode} onCheckedChange={setAdvancedSearchMode} />
              </div>
            </CardContent>
          </Card>
                ...
                {advancedSearchMode && similarImages.length > 0 && (
                  <div className="space-y-4 p-4 bg-muted rounded-lg border border-border">
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3">
                      {similarImages
                        .slice(0, showAllSimilarImages ? similarImages.length : 8)
                        .map((image, index) => (
                  ...
                  <div className="h-full flex items-center justify-center text-muted-foreground p-6">
                    <div className="text-center space-y-3">
                      ...
                      <p className="text-base font-medium">
                        {t('imageRecognition.noAnalysisResult')}
                      </p>
