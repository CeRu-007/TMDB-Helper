...
export const IQIYI_BASE_PARAMS = {
  ...
  pull_type: '1',
  profile:
    '{"group":"1,2","counter":1,"hy_id":"","first_time":"20260131","recall_firstdate":"-1","recall_time":"","isSilent":"0"}',
  bi_params:
    '{"viptab":"cid_order_list_1","PHA-ADR_PHA-APL_1_pbyx":"pbyx_7","PHA-ADR_PHA-APL_1_djrz_title":"title_1","people_id":"0","ct":"20260131","vipService":"new","design":"1","ad_third":"yes","smallvideo":"1","bi_recommend_reason":"recreason","wdym_hd":"0"}',
} as const;
