        ...
        <div className="p-4 space-y-4">
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-500">更新至{episode.pubIndex}</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1">
                <Badge variant="outline" className="text-xs bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 border-0">小说改</Badge>
                <Badge variant="outline" className="text-xs bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 border-0">玄幻</Badge>
              </div>
            </div>
          </div>
