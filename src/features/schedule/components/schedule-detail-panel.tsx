        ...
        <ScrollArea className="flex-1">
          <div className="p-4 space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">
                  {episode.pubIndex.startsWith('更新')
                    ? episode.pubIndex
            ...
            <div className="space-y-2">
              <Button
                className={cn(
                  ...
                  isFollowing ? 'bg-rose-500 hover:bg-rose-600' : 'bg-blue-500 hover:bg-blue-600'
                )}
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">暂无简介信息</p>
            </div>
          </div>
        </ScrollArea>
      </div>
