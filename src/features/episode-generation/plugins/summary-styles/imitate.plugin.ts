...
export const imitatePlugin: ISummaryStylePlugin = new (class
  extends BasePlugin
  implements ISummaryStylePlugin
{
  constructor() {
    super({
      ...
      name: '模仿',
      description: '根据提供的样本内容，模仿其写作风格和表达方式生成简介',
      icon: '🎭',
      version: '1.0.0',
      author: 'TMDB-Helper',
      isBuiltin: true,
  ...
  buildPrompt(content: EpisodeContent, options?: Record<string, any>): string {
    ...
    return `你是一位专业的影视内容编辑，擅长撰写模仿风格的简介。

任务：为第 ${content.episodeNumber} 集撰写模仿风格的简介
