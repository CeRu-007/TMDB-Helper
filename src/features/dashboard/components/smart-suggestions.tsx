...
const TYPE_CONFIG: Record<
  string,
  { icon: React.ElementType; bgClass: string; textClass: string; borderClass: string }
> = {
  warning: {
    icon: Warning,
...
export function SmartSuggestions({ suggestions }: SmartSuggestionsProps) {
  ...
  return (
    <div className="rounded-xl border border-border bg-muted/50 p-4 md:p-5">
      <h3 className="text-sm font-medium text-foreground mb-3 md:mb-4">{t('smartSuggestions')}</h3>
