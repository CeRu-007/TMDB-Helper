...
export const useMediaNewsStore = create<MediaNewsState>()(
  devtools(
    (set, get) => ({
      ...
      setLoadingUpcoming: (loadingUpcoming) =>
        set({ loadingUpcoming }, false, 'setLoadingUpcoming'),

      setLoadingRecent: (loadingRecent) => set({ loadingRecent }, false, 'setLoadingRecent'),

      setUpcomingError: (upcomingError) =>
        set({ upcomingError, loadingUpcoming: false }, false, 'setUpcomingError'),

      setRecentError: (recentError) =>
        set({ recentError, loadingRecent: false }, false, 'setRecentError'),

      setUpcomingLastUpdated: (time, region) =>
        set(
          (state) => ({
      ...
      setRecentLastUpdated: (time, region) =>
        set(
          (state) => ({
      ...
      setIsMissingApiKey: (isMissingApiKey) =>
        set({ isMissingApiKey }, false, 'setIsMissingApiKey'),

      setSelectedRegion: (selectedRegion) => set({ selectedRegion }, false, 'setSelectedRegion'),

      setMediaNewsType: (mediaNewsType) => set({ mediaNewsType }, false, 'setMediaNewsType'),
