...
(function() {
  try {
    ...
    var themes = {
      ...
      'tmdb': { bg:'0 0% 100%', fg:'207 91% 13%', card:'0 0% 100%', cardFg:'207 91% 13%', primary:'207 91% 13%', primaryFg:'0 0% 100%', secondary:'210 40% 96%', secondaryFg:'207 60% 20%', muted:'210 40% 94%', mutedFg:'207 20% 50%', accent:'207 85% 95%', accentFg:'207 91% 13%', destructive:'0 84% 60%', destructiveFg:'0 0% 100%', border:'207 20% 88%', input:'207 20% 88%', ring:'207 91% 13%', radius:'0.5rem', appearance:'light', header:'207 91% 13%', headerFg:'0 0% 100%' }
    };
