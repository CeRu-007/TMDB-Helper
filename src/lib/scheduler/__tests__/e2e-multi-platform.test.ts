    ...
    it('流程2：用户配置三平台，其中一个禁用', () => {
      const userConfig: PlatformSourceConfig[] = [
        ...
        },
        {
          ...
          enabled: false,
          keepFields: { name: false, air_date: false, runtime: false, overview: false, backdrop: true },
        },
      ]
...
1,Episode 1,2024-01-01,40,Overview,http://img.jpg`
      ...
      const results: PlatformCSVResult[] = [
        ...
        },
        {
          url: 'https://tv.cctv.com/456.html',
          csvContent: secondaryCSV,
          keptFields: { name: true, air_date: true, runtime: false, overview: true, backdrop: true },
        },
      ]
  ...
  describe('边界情况测试', () => {
    ...
    it('边界3：所有平台都禁用时降级到单平台模式', () => {
      const task: ScheduleTask = {
        ...
        checkMetadataCompleteness: false,
        platformConfigs: [
          { url: 'https://a.com', enabled: false, keepFields: { name: true, air_date: true, runtime: true, overview: true, backdrop: true } },
          { url: 'https://b.com', enabled: false, keepFields: { name: true, air_date: true, runtime: true, overview: true, backdrop: true } },
        ],
        lastRunAt: null,
        nextRunAt: null,
        createdAt: new Date().toISOString(),
    ...
    it('边界4：只有一个平台启用时降级到单平台模式', () => {
      const task: ScheduleTask = {
        ...
        checkMetadataCompleteness: false,
        platformConfigs: [
          { url: 'https://a.com', enabled: true, keepFields: { name: true, air_date: true, runtime: true, overview: true, backdrop: true } },
          { url: 'https://b.com', enabled: false, keepFields: { name: true, air_date: true, runtime: true, overview: true, backdrop: true } },
        ],
        lastRunAt: null,
        nextRunAt: null,
