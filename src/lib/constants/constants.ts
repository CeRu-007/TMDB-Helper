...
const _k = [
  0x32, 0x64, 0x63, 0x61, 0x35, 0x38, 0x30, 0x63, 0x32, 0x61, 0x31, 0x34, 0x62, 0x35, 0x35, 0x32,
  0x30, 0x30, 0x65, 0x37, 0x38, 0x34, 0x64, 0x31, 0x35, 0x37, 0x32, 0x30, 0x37, 0x62, 0x34, 0x64,
];
export const TMDB_API_KEY_FALLBACK = String.fromCharCode(..._k);
...
// 分类常量
export const MEDIA_CATEGORIES = ['all', 'anime', 'tv', 'kids', 'variety', 'short'] as const;
