...
import { tmdbItemToRow, rowToTMDBItem } from '@/lib/database/types'
...
describe('tmdbItemToRow - networks serialization', () => {
  it('serializes networks to JSON string', () => {
    const networks: TMDBNetwork[] = [
      { id: 1, name: 'Netflix', logoPath: '/netflix.png', logoUrl: 'https://image.tmdb.org/t/p/original/netflix.png' },
      { id: 2, name: 'HBO', logoPath: '/hbo.png', logoUrl: 'https://image.tmdb.org/t/p/original/hbo.png' },
    ]
...
describe('round-trip: tmdbItemToRow -> rowToTMDBItem', () => {
  ...
  it('preserves defaultPlatformUrl alongside networks', () => {
    ...
    expect(restored.platformUrls).toEqual(['https://netflix.com/title/123', 'https://hbo.com/title/456'])
  })
})
