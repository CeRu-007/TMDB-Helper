          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="space-y-1">
              <div>
                ...
                {t('csvEditor.help.editCell')}
              </div>
              <div>
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Tab</kbd>{' '}
                {t('csvEditor.help.moveNext')}
              </div>
              <div>
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+C</kbd>{' '}
                {t('csvEditor.help.copy')}
              </div>
              <div>
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+V</kbd>{' '}
                {t('csvEditor.help.paste')}
              </div>
              <div>
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+Z</kbd>{' '}
                {t('csvEditor.help.undo')}
              </div>
              <div>
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Del</kbd>{' '}
                {t('csvEditor.help.delete')}
              </div>
              <div>
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+Shift++</kbd>{' '}
                {t('csvEditor.help.insertRow')}
              </div>
              <div>
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+Alt++</kbd>{' '}
                {t('csvEditor.help.insertColumn')}
              </div>
            </div>
