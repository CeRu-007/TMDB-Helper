...
export function LanguageSelector({ value, onChange, size = 'sm' }: LanguageSelectorProps) {
  const currentLanguage: Language = LANGUAGES.find((lang) => lang.code === value) ?? LANGUAGES[0];
