...
export function PlatformIcon({ platform, size = 24, className = '' }: PlatformIconProps) {
  ...
  switch (platform) {
    case 'netflix':
      return (
        <svg {...svgProps} viewBox="0 0 24 24">
          <path d="M5 2V22L12.3182 20.5L19.5 22V2H5Z" fill={fillColor} fillOpacity="0.1" />
          <path d="M15 2V18.5L12 17.5L9 18.5V2H15Z" fill={fillColor} />
        </svg>
      );
      ...
      return (
        <svg {...svgProps} viewBox="0 0 24 24">
          <path
            ...
            fillOpacity="0.1"
          />
          <path d="M15 9.5L10.5 7V12L15 14.5V9.5Z" fill={fillColor} />
        </svg>
      );
    ...
    case 'bilibili':
      return (
        <svg {...svgProps} viewBox="0 0 24 24">
          <rect x="3" y="6" width="18" height="14" rx="2" fill={fillColor} fillOpacity="0.1" />
          <circle cx="8" cy="12" r="1.5" fill={fillColor} />
          <circle cx="16" cy="12" r="1.5" fill={fillColor} />
          <path d="M3 9H21" stroke={fillColor} strokeWidth="1.5" />
        </svg>
      );
    ...
    default:
      return (
        <svg {...svgProps} viewBox="0 0 24 24">
          <rect x="3" y="5" width="18" height="14" rx="2" fill={fillColor} fillOpacity="0.1" />
...
export function PlatformLogo({
  ...
  const platformType = PLATFORM_TYPES.includes(iconType as any) ? iconType : 'generic';
