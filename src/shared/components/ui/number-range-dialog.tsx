    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[400px]">
        <DialogHeader>
          ...
          <DialogDescription>设置起始值和步长，自动递增填充选中的单元格</DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="text-sm text-muted-foreground text-center">将应用于 {count} 个单元格</div>
        </div>
        ...
        <DialogFooter>
          ...
          <Button
            onClick={handleApply}
            disabled={
              !startValue || !step || parseInt(startValue, 10) <= 0 || parseInt(step, 10) <= 0
            }
          >
            应用
          </Button>
