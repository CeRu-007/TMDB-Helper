  ...
  const startAnalysis = useCallback(async () => {
    ...
    try {
      if (advancedSearchMode) {
        ...
        const similarSearchResponse = await fetch('/api/image-recognition/similar-search', {
          method: 'POST',
          headers: {
      ...
      const analysisResponse = await fetch('/api/image-recognition/analyze', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const searchResponse = await fetch('/api/image-recognition/search', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
