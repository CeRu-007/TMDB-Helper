...
const SortablePlatformCard: React.FC<{
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative bg-white dark:bg-slate-800/90 rounded-2xl shadow-sm hover:shadow-lg border border-gray-100 dark:border-slate-700/50 transition-all duration-300 overflow-hidden",
        isDragMode 
